...
*/
	...
	SEMICOLON.header = {
		...
		menufunctions: function(){
			...
			$( '.top-links ul li:has(ul) > a, #primary-menu.with-arrows > ul > li:has(ul) > a > div, #primary-menu.with-arrows > div > ul > li:has(ul) > a > div, #page-menu nav ul li:has(ul) > a > div' ).append( '<i class="fa-angle-down"></i>' );
		...
		handleLazyLoad: function() {
			...
			if( lazyLoadEl.length > 0 ) {
				lazyLoadEl.each( function(){
					...
					element.attr( 'src', '//bizweb.dktcdn.net/100/093/224/themes/188346/assets/blank.svg?1480667786742' ).css({ 'background': 'url(//bizweb.dktcdn.net/100/093/224/themes/188346/assets/preloader.gif?1480667786742) no-repeat center center #FFF' });
